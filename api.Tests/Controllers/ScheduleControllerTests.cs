...
public class ScheduleControllerTests
{
    ...
    // Test error occuring when retreiving EventIds of Events related to specific Availability
    [Fact]
    public async Task TestGetScheduledEventIdsNotOk()
    {
        // Arrange
    ...
    // Test retreival of EventId from Events related to specific Availability on specific date
    [Fact]
    ...
    // Test error occuring when retreiving of EventId from Events related to specific Availability on specific date
    [Fact]
    public async Task TestFindScheduledEventIdNotOk()
    {
        // Arrange
    ...
    // Test for creating Schedules
    [Fact]
    public async Task TestCreateSchedules()
    {
        // Arrange
    ...
    [Fact]
    public async Task TestUpdateScheduledAvailabilityNotOk()
    {
        // Arrange
    ...
    // Test for Updating Availability of Schedules
    [Fact]
    public async Task TestUpdateScheduledEvent()
    {
        // Arrange
    ...
    // Test for Edeleting Schedules by their EventId
    [Fact]
    public async Task TestDeleteSchedulesByEventId()
    {
        // Arrange
    ...
    // Test for Error occuring when deleting Schedules by their EventId
    [Fact]
    ...
    // Test for deleting Schedules by their eventId and availabilityIds
    [Fact]
    public async Task TestDeleteAfterEventUpdate()
    {
        // Arrange
    ...
    // Test for error occuring when deleting Schedules by their eventId and availabilityIds
    [Fact]
    public async Task TestDeleteAfterEventUpdateNotOk()
    {
        // Arrange
